...
export default function Users({
    ...
    const [roleInfoModal, setRoleInfoModal] = useState<RoleInfoModal | null>(
        null,
    );
    ...
    const roleTone = (role: string) =>
        role === 'admin'
            ? {
                  ...
                  description:
                      'Administrative access for assigned platform features.',
            ...
            : {
                  ...
                  description:
                      'Decision-maker access for assigned platform features.',
        ...
        <div className="space-y-6 p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                {Object.entries(roles).map(([key, role]) => {
                    const roleModules = moduleOptionsForRole(key);
                    const tone = roleTone(key);
                        ...
                        <Card key={key} className="rounded-lg">
                            <CardHeader className="flex-row items-start justify-between gap-4">
                                <div className="flex gap-3">
                                    <div
                                        className={`flex size-11 shrink-0 items-center justify-center rounded-lg ${tone.iconClass}`}
                                    >
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            setRoleInfoModal({
                                                ...
                                                modules: roleModules.map(
                                                    (module) => module.label,
                                                ),
                                            })
                                        }
                                        className="size-7 rounded-full"
                                        aria-label={`View ${role.label} role information`}
                                    >
                                        <Info className="size-4 text-muted-foreground" />
                                    </Button>

                                    <span
                                        className={`rounded-full border px-3 py-1 text-xs font-medium ${tone.chipClass}`}
                                    >
                                        {roleModules.length} modules
                                    </span>
                                </div>
                            </CardHeader>
                    ...
                    <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-lg">
                        <div className="mb-5 flex items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    {roleInfoModal.description}
                                </p>
                            </div>

                            <button
                                type="button"
                                onClick={() => setRoleInfoModal(null)}
                        ...
                        <ul className="grid gap-2 text-sm">
                            {roleInfoModal.modules.map((module) => (
                                <li
                                    key={module}
                    ...
                    <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-lg">
                        <div className="mb-5 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Create an account and assign its system
                                    role.
                                </p>
                            </div>
                        ...
                        <form className="space-y-4" onSubmit={submitUser}>
                            ...
                            <div className="rounded-2xl border border-slate-200 p-4">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    Select only the modules this account can
                                    access.
                                </p>

                                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                                    {moduleOptionsForRole(data.role).map(
                                        (module) => (
                                            <label
                                                key={module.key}
                    ...
                    <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-lg">
                        ...
                        <form className="space-y-4" onSubmit={updateUser}>
                            ...
                            <div className="rounded-2xl border border-slate-200 p-4">
                                ...
                                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                                    {moduleOptionsForRole(editData.role).map(
                                        (module) => (
                                            <label
                                                key={module.key}
                                                className="flex items-center gap-2 text-sm"
